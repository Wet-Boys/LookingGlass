...
namespace LookingGlass.StatsDisplay
{
    internal class StatsDisplayDefinitions
    {
        ...
        internal static void SetupDefs()
        {
            ...
            StatsDisplayClass.statDictionary.Add("baseDamage", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.baseDamage).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("crit", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.crit).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("attackSpeed", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.attackSpeed).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("regen", cachedUserBody => { return $"<style=\"cIsHealing>{(cachedUserBody.regen).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("killCount", cachedUserBody => { return $"<style=\"cIsHealth>{(cachedUserBody.killCountServer).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("maxHealth", cachedUserBody => { return $"<style=\"cIsHealth>{(cachedUserBody.maxHealth).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("damage", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.damage).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("critMultiplier", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.critMultiplier).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("bleedChance", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.bleedChance).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("critHeal", cachedUserBody => { return $"<style=\"cIsHealing>{(cachedUserBody.critHeal).ToString()}</style>"; });
            ...
            StatsDisplayClass.statDictionary.Add("canPerformBackstab", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.canPerformBackstab).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("canReceiveBackstab", cachedUserBody => { return $"<style=\"cIsDamage>{(cachedUserBody.canReceiveBackstab).ToString()}</style>"; });
            StatsDisplayClass.statDictionary.Add("healthPercentage", cachedUserBody => { return $"<style=\"cIsHealth>{(cachedUserBody.healthComponent.combinedHealthFraction * 100f).ToString()}</style>"; });

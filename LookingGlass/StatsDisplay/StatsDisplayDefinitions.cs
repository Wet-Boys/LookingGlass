...
namespace LookingGlass.StatsDisplay
{
    internal class StatsDisplayDefinitions
    {
        ...
        internal static void SetupDefs()
        {
            ...
            {
                float critWithLuck = Utils.CalculateChance(cachedUserBody.crit, Utils.GetLuckFromCachedUserBody(cachedUserBody)) * 100f;
            ...
            {
                float bleedChanceWithLuck = Utils.CalculateChance(cachedUserBody.bleedChance, Utils.GetLuckFromCachedUserBody(cachedUserBody)) * 100f;
            ...
            StatsDisplayClass.statDictionary.Add("instaKillChance", cachedUserBody => {
                ...
                float instakillChance = Utils.CalculateChance(.5f * stackCount, Utils.GetLuckFromCachedUserBody(cachedUserBody)) * 100f;
